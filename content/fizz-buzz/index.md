...
<p class="codepen" data-height="550" data-default-tab="result" data-slug-hash="gbrQeMq" data-pen-title="CSS-only animated Fizz Buzz (no HTML)" data-preview="true" data-user="t_afif" style="height: 550px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
      <span>See the Pen <a href="https://codepen.io/t_afif/pen/gbrQeMq">
  CSS-only animated Fizz Buzz (no HTML)</a> by Temani Afif (<a href="https://codepen.io/t_afif">@t_afif</a>)
  on <a href="https://codepen.io">CodePen</a>.</span>
</p>
