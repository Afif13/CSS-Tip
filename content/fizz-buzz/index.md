...
<p class="codepen" data-height="450" data-default-tab="result" data-slug-hash="gbrQeMq" data-pen-title="CSS-only animated Fizz Buzz (no HTML)" data-preview="true" data-user="t_afif" style="height: 450px; box-sizing: border-box; display: flex; align-items: center; justify-content: center; border: 2px solid; margin: 1em 0; padding: 1em;">
